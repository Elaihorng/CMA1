        ...
        <div class="col-12">
          <div class="row">
            {{-- <div class="form-group col-6">
              ...
              <input type="text" name="teacher_code" value="{{$teacher->teacher_code}}" class="form-control" id="exampleInputPassword1" >
              @error('teacher_code')
        ...
        <div class="col-12">
          <div class="row">
            ...
            <div class="form-group col-6">
              ...
              <input type="text" name="stock_quantity" value="{{$product->stock_quantity}}" class="form-control" id="exampleInputPassword1" >
        ...
        <div class="col-12">
          <div class="row">
            <div class="form-group col-12 ">
              ...
              <textarea class="form-control"   name="description"  rows="2" placeholder="Enter...."> {{ old('description', $product->description) }}</textarea>
            </div>
