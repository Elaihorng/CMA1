...
use App\Http\Controllers\backend\BStockController;
...
Route::post('/cart/update/{product_id}', [CartController::class, 'update'])->name('frontend.cart.update');
Route::post('/cart/check-stock', [CartController::class, 'checkStock'])->name('frontend.cart.check-stock');
...
Route::controller(AuthController::class)->group(function() {
    ...
    Route::post('/forget', 'handleForget')->name('forget.password');
...
Route::post('/stock-in', [BStockController::class, 'stockIn'])->name('stock.in');
Route::post('/stock-out', [BStockController::class, 'stockOut'])->name('stock.out');
Route::resource('stocks', BStockController::class)->only(['index']);
Route::get('/stocks/history', [BStockController::class, 'history'])->name('stock.history');
